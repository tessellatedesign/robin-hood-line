 ...
 */
( function() {
	/** globals frmDom, wp, frmAutocompleteApplicationName */
	...
	function getApplicationDropdown( $modal ) {
		...
		if ( applicationId && 'undefined' !== typeof frmAutocompleteApplicationName ) {
			dropdown.querySelector( '#frm_application_autocomplete_input' ).value = frmAutocompleteApplicationName;
